'''
Author: souldream
Date: 2022-04-29 15:24:23
LastEditTime: 2022-05-01 15:14:23
LastEditors: souldream
Description: 
FilePath: \朵朵\qt\lrc_img.py
...
class Lrc_img:
    ...
    def get_rank_img(self):
        ...
        cropped.save("img/lrc/lrc.jpg")

    def get_small_img(self):
        img = Image.open(("img/lrc/lrc.jpg"))
        ...
        for j in range(self.row):
            ...
            cropped.save("img/lrc/lrc_{}.jpg".format(j))
